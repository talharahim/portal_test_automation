...
public class Dashboard_Transfers extends DashBoard {
    ...
    @FindBy(css = "div.requiered-field")
    ...
    public void submitStartStopServiceTransferOrder(String scheduleDate, String serviceName, String defaultCustomer,
	    String requestCustomer, String description) throws InterruptedException {
