...
public class TC0018_verifyDrillbacksGeneral extends BaseClass {
    ...
    // cogsdrillback://DGPB/?Db=SQL_2017&Srv=RND-BASE-A&Cmp=TWO&Prod=229&Act=OPEN&Func=CustomerMaintenance&CustomerID=0000011111&LocationID=LOC@0004&CogsDrillback=1'
    // not Matched the expected value
    // 'cogsdrillback://DGPB/?Db=SQL_2017&Srv=RND-BASE-A&Cmp=TWO&Prod=229&Act=OPEN&Func=CustomerMaintenance&CustomerId=0000011111&LocationID=LOC@0004&CogsDrillback=1
    public String secondCustURL = serverUrl + "Bug reported";

    public String servTabURL = serverUrl + "kk";

    public String contLogURL = serverUrl + "Prod=229&Act=OPEN&Func=ServiceOrder&CustomerID=" + customerId
	    + "&LocationID=" + locationID + "&ServiceOrder=1&CogsDrillback=1";
...
//This Test will test the search by Customer ID
    @Test(priority = 1)
    public void verifyDrillbacksGeneral()
	...
	dashBoard.verifyDrillback("ENH_Location_Drillback", enhancedNotesLocURL, enhenabled);
