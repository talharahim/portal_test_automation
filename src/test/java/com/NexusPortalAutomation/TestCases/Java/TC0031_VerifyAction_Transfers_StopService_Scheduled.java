...
public class TC0031_VerifyAction_Transfers_StopService_Scheduled extends BaseClass {
	...
	public String locationID = getCellvalue("TC0031", "locationID");//"LOC@0004";
	public String locationID2 = getCellvalue("TC0031", "locationID2");//"LOC@0005";
	public String defaultCustomer = getCellvalue("TC0031", "defaultCustomer");//"Mr. VACANT VACANT";
	public String requestedbY = getCellvalue("TC0031", "requestedbY");//"Mr. Automation Mate";
	public String moveOutCustomer = getCellvalue("TC0031", "moveOutCustomer");//"Mr. Automation Mate";
	public String loc2moveOutCustomer = getCellvalue("TC0031", "loc2moveOutCustomer");//"Mr. Movein Cus";
	public String moveInCustomer = getCellvalue("TC0031", "moveInCustomer");//"Mr. Vacant Vacant (Vacant)";
	public String loc2moveInCustomer = getCellvalue("TC0031", "loc2moveInCustomer");//"Mr. Automation Mate (0000011111)";
	public String serverUrl = getDrillbackServerUrl();
	public String task1 = getCellvalue("TC0031", "task1");//"Meter Reading-electric";
	public String task2 = getCellvalue("TC0031", "task2");//"Charge New Customer";
	public String task3 = getCellvalue("TC0031", "task3");//"Property Transfer";
	public String task4 = getCellvalue("TC0031", "task4");//"Deposit Request-new Customer";
	public String task5 = getCellvalue("TC0031", "task5");//"Deposit Payment-new Customer E";
	public String task6 = getCellvalue("TC0031", "task6");//"Prepayment Required-new Custom";
	public String message = getCellvalue("TC0031", "message");//"Transfer initiated";
